...
| 3+ (Subscribers) | | | email@example.com | TRUE | FALSE | ... |

- **Row 2, columns D+**: USGS gauge numbers
- **Row 3+, column C**: Subscriber email address
- **Row 3+, columns D+**: TRUE/FALSE for each gauge
